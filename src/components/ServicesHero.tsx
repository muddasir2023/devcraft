      ...
      <div className="container-custom">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-agency-blue mb-6 animate-fade-in">
            Our <span className="text-agency-accent">Services</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            End-to-end digital solutions tailored for businesses looking to innovate and scale in the digital landscape.
          </p>
        </div>
      </div>
